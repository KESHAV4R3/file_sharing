  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-2xl overflow-hidden">
        <div className="grid grid-cols-[1fr_80px_100px_100px_40px] gap-2 px-6 py-3 bg-slate-800/50 border-b border-slate-800 text-xs font-semibold text-slate-400 uppercase tracking-wider">
          <span>User</span>
          ...
          <div className="divide-y divide-slate-800/60">
            {filtered.map((u) => (
              <button
                ...
                className="w-full grid grid-cols-[1fr_80px_100px_100px_40px] gap-2 px-6 py-4 hover:bg-slate-800/40 transition-colors text-left group"
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-slate-600 font-mono truncate">{u.id}</p>
                  </div>
                </div>
